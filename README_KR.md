...
| 질  문 | 설  명 | 응  용 |
|------|------|------|
| **Q1: 핵심 노드 탐지** | 제거 시 테러 네트워크를 가장 효과적으로 와해시키는 노드는? | 개입 대상 우선순위 결정 |
| **Q2: 시간적 회복력** | 테러 조직 와해 후 네트워크가 어떻게 재구성될 것인가? | 사후 개입 모니터링 전략 |
| **Q3: 적대적 강건성** | 테러 네트워크가 와해 시도에 어떻게 적응하는가? | 대응 적응 전술 |
...
| 메트릭 | 본 연구의 방법론 | EvolveGCN | Dynamic GCN | PageRank | Random |
|--------|-----------|-----------|-------------|----------|--------|
