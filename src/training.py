...
class EnhancedNegativeSampler:
    ...
    def sample(
        ...
        if self.strategy == 'uniform':
            ...
            return self._hard_negative_sampling(num_nodes, pos_edges, num_neg_samples, embeddings, device)
        else:
            return self._uniform_sampling(num_nodes, pos_edges, num_neg_samples, device)
        ...
        for network in train_networks:
            ...
            for t in range(num_timesteps - 1):
                ...
                neg_edges = self.negative_sampler.sample(
                    num_nodes_t1, agg_edge_index_t1, num_neg_edges, 
                    embeddings_t1, self.device
                )
                ...
                graph_recon_loss = self.graph_recon_loss(embeddings_t1, agg_edge_index_t1, neg_edges)
