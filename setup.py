...
setup(
    ...
    url='https://github.com/yourusername/terrorist-network-gnn',
    project_urls={
        'Bug Tracker': 'https://github.com/yourusername/terrorist-network-gnn/issues',
        'Documentation': 'https://yourusername.github.io/terrorist-network-gnn/',
        'Source Code': 'https://github.com/yourusername/terrorist-network-gnn',
    },
